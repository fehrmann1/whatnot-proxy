// Erzwinge Node.js 20 (Puppeteer-kompatibel) und setze EU/USA-Regionen
export const config = {
  runtime: "nodejs20",
  regions: ["fra1", "iad1"]
};
